...
//  { title: '', desc: '', imgURL: '', stack: ['React', 'React Router'], repo: '', demo: '' },
    { title: 'Apple.com Navigation', desc: 'A navigation that is created with nested routes in React Router.', imgURL: 'images/applenav.png', stack: ['React', 'React Router'], repo: 'https://github.com/sametweb/React-Router-Apple-Nav', demo: 'https://apple-navsm.netlify.com/' },
